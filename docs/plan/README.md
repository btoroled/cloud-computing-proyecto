# Planes de trabajo por sección

Desglose detallado del [plan general](../plan-de-trabajo.md), una sección por archivo. Cada plan tiene:
entregables + Definición de Terminado, asignación, tabla de tareas (ID · responsable · estimación en
días-persona · fase · dependencias · DoD), mapa a hitos, camino crítico y riesgos propios.

| Sección | Rúbrica | Archivo | Estado |
|---|---|---|---|
| Backend — Microservicios | 7 pts | [`backend.md`](backend.md) | ✅ |
| Frontend — Web | 3 pts | [`frontend.md`](frontend.md) | ✅ |
| Data Science — Analytics | 5 pts | [`data-science.md`](data-science.md) | ✅ |
