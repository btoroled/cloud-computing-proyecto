...
Las pruebas de MS2 utilizan el perfil de pruebas con PostgreSQL/H2
según el escenario y cubren las operaciones principales del dominio:
CRUD de aerolíneas, aeronaves y vuelos, consultas de empleados,
asignación de tripulación, filtros de vuelos, transiciones de estado,
validación de vuelos mediante \texttt{/exists} y respuestas del
